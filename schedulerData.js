  ...
  function SchedulerData() {
    var date =
      arguments.length > 0 && arguments[0] !== undefined
        ? arguments[0]
        : (0, _moment2.default)().format(_index.DATE_FORMAT);
    var viewType =
      arguments.length > 1 && arguments[1] !== undefined
        ? arguments[1]
        : _index.ViewTypes.Week;
    var showAgenda =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    var isEventPerspective =
    ...
    this.cellUnit =
      viewType === _index.ViewTypes.Day
        ? _index.CellUnits.Hour
        : _index.CellUnits.Day;
    ...
    this.config =
      newConfig == undefined
        ? _config2.default
        : _extends({}, _config2.default, newConfig);
    this._validateMinuteStep(this.config.minuteStep);
    this.behaviors =
      newBehaviors == undefined
        ? _behaviors2.default
        : _extends({}, _behaviors2.default, newBehaviors);
  ...
  _createClass(SchedulerData, [
    ...
    },
    {
      ...
      value: function isResourceViewResponsive() {
        ...
        return (
          !!resourceTableWidth.endsWith && resourceTableWidth.endsWith("%")
        );
      },
    },
    {
    ...
    },
    {
      ...
      value: function getSchedulerWidth() {
        ...
        return this.isSchedulerResponsive()
          ? parseInt(
              (baseWidth * Number(this.config.schedulerWidth.slice(0, -1))) /
                100
            )
    ...
    },
    {
      ...
      value: function getContentCellWidth() {
        ...
        return this.isContentViewResponsive()
          ? parseInt(
              (schedulerWidth * Number(contentCellConfigWidth.slice(0, -1))) /
                100
            )
    ...
    },
    {
      ...
      value: function getCellMaxEvents() {
        return this.viewType === _index.ViewTypes.Week
          ? this.config.weekMaxEvents
          : this.viewType === _index.ViewTypes.Day
          ? this.config.dayMaxEvents
          : this.viewType === _index.ViewTypes.Month
          ? this.config.monthMaxEvents
          : this.viewType === _index.ViewTypes.Year
          ? this.config.yearMaxEvents
          : this.viewType === _index.ViewTypes.Quarter
    ...
    },
    {
      ...
      value: function isEventInTimeWindow(
        eventStart,
        eventEnd,
        windowStart,
        windowEnd
      ...
      value: function _handleRecurringEvents() {
        ...
        recurringEvents.forEach(function (item) {
          ...
          if (
            ...
            windowEnd < _this2.localeMoment(rule.origOptions.until)
          ) {
    ...
    },
    {
      ...
      value: function _resolveDate(num) {
        ...
        if (date != undefined)
          this.selectDate = this.localeMoment(date).format(_index.DATE_FORMAT);
        ...
        if (this.viewType === _index.ViewTypes.Week) {
          ...
          this.viewType === _index.ViewTypes.Custom ||
          this.viewType === _index.ViewTypes.Custom1 ||
          this.viewType === _index.ViewTypes.Custom2
        ) {
          ...
          if (this.cellUnit === _index.CellUnits.Hour) {
            ...
            while (header >= start && header <= end) {
              ...
              for (var i = 0; i < minuteSteps; i++) {
                ...
                if (
                  ...
                  var nonWorkingTime = this.behaviors.isNonWorkingTimeFunc(
                    this,
                    time
                  );
            ...
            while (header >= start && header <= end) {
              ...
              if (
                ...
                var _nonWorkingTime = this.behaviors.isNonWorkingTimeFunc(
                  this,
                  _time
                );
    ...
    },
    {
      ...
      value: function _createInitHeaderEvents(header) {
        ...
        var endValue = this.showAgenda
          ? this.viewType === _index.ViewTypes.Week
            ? start.add(1, "weeks").format(_index.DATETIME_FORMAT)
            : this.viewType === _index.ViewTypes.Day
            ? start.add(1, "days").format(_index.DATETIME_FORMAT)
            : this.viewType === _index.ViewTypes.Month
            ? start.add(1, "months").format(_index.DATETIME_FORMAT)
            : this.viewType === _index.ViewTypes.Year
            ? start.add(1, "years").format(_index.DATETIME_FORMAT)
            : this.viewType === _index.ViewTypes.Quarter
            ? start.add(1, "quarters").format(_index.DATETIME_FORMAT)
            : this.localeMoment(this.endDate)
                .add(1, "days")
                .format(_index.DATETIME_FORMAT)
          : this.cellUnit === _index.CellUnits.Hour
          ? start
              .add(this.config.minuteStep, "minutes")
              .format(_index.DATETIME_FORMAT)
          : start.add(1, "days").format(_index.DATETIME_FORMAT);
        return {
          time: header.time,
    ...
    },
    {
      ...
      value: function _createInitRenderData(
        isEventPerspective,
        eventGroups,
        resources,
        headers
        ...
        slots.forEach(function (slot) {
          ...
          var slotRenderData = {
            ...
            rowMaxCount: 0,
            rowHeight:
              _this4.config.nonAgendaSlotMinHeight !== 0
                ? _this4.config.nonAgendaSlotMinHeight
                : _this4.config.eventItemLineHeight + 2,
    ...
    },
    {
      ...
      value: function _getSpan(startTime, endTime, headers) {
        ...
        try {
          for (
            var _iterator = headers[Symbol.iterator](), _step;
    ...
    },
    {
      ...
      value: function _createRenderData() {
        ...
        var initRenderData = this._createInitRenderData(
            ...
            resourceEvents.headerItems.forEach(function (header, index) {
              ...
              if (headerEnd > eventStart && headerStart < eventEnd) {
                ...
                if (header.count > resourceEvents.rowMaxCount) {
                  ...
                  var newRowHeight =
                    rowsCount * _this5.config.eventItemLineHeight +
                    (_this5.config.creatable &&
                    _this5.config.checkConflict === false
                      ? 2
                      : 2);
                ...
                if (render === false) {
                  ...
                  var previousHeaderStart = _this5.localeMoment(
                      previousHeader.start
                    ),
                ...
                header.events[pos] = _this5._createHeaderEvent(
                  render,
                  span,
                  item
                );
          ...
          initRenderData.forEach(function (resourceEvents) {
            ...
            resourceEvents.headerItems.forEach(function (headerItem) {
              ...
              if (_this5.behaviors.getSummaryFunc !== undefined) {
                ...
                headerItem.summary = _this5.behaviors.getSummaryFunc(
                  _this5,
                  events,
                ...
                if (
                  !!headerItem.summary &&
                  headerItem.summary.text != undefined
                )
                  hasSummary = true;
              }
            });
            ...
            if (hasSummary) {
              ...
              var newRowHeight = resourceEvents.rowHeight;
              if (newRowHeight > resourceEvents.rowHeight)
                resourceEvents.rowHeight = newRowHeight;
            }
          });
