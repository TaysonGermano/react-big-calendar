    ...
    (function (_Component) {
      ...
      function Summary(props) {
        ...
        return _possibleConstructorReturn(
          this,
          (Summary.__proto__ || Object.getPrototypeOf(Summary)).call(
            this,
            props
          )
        );
      ...
      _createClass(Summary, [
        {
          ...
          value: function render() {
            ...
            if (
              config.summaryPos === _index.SummaryPos.TopRight ||
              config.summaryPos === _index.SummaryPos.BottomRight
            )
              textAlign = "center";
            else if (
              config.summaryPos === _index.SummaryPos.TopLeft ||
              config.summaryPos === _index.SummaryPos.BottomLeft
            )
              textAlign = "left";
            var style = {
              color: color,
            ...
            if (summary.fontSize != undefined)
              style = _extends({}, style, { fontSize: summary.fontSize });
