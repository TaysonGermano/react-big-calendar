...
exports.isNonWorkingTime =
  exports.getScrollSpecialMoment =
  exports.getEventText =
  exports.getDateLabel =
  exports.getNonAgendaViewBodyCellBgColor =
  exports.getCustomDate =
  exports.getSummary =
    undefined;
...
var getCustomDate = (exports.getCustomDate = function getCustomDate(
  schedulerData,
  num
) {
  var date =
  ...
  if (viewType === _index.ViewTypes.Custom1) {
    ...
    var firstDayOfMonth = schedulerData
      .localeMoment(selectDate)
      .startOf("month")
      .format(_index.DATE_FORMAT);
    startDate =
...
var getNonAgendaViewBodyCellBgColor = (exports.getNonAgendaViewBodyCellBgColor =
...
var getDateLabel = (exports.getDateLabel = function getDateLabel(
  schedulerData,
  viewType,
  startDate,
  endDate
  ...
  if (
    viewType === _index.ViewTypes.Week ||
    (start != end &&
      (viewType === _index.ViewTypes.Custom ||
        viewType === _index.ViewTypes.Custom1 ||
        viewType === _index.ViewTypes.Custom2))
  ) {
...
var getEventText = (exports.getEventText = function getEventText(
  schedulerData,
  event
) {
...
var getScrollSpecialMoment = (exports.getScrollSpecialMoment =
  function getScrollSpecialMoment(schedulerData, startMoment, endMoment) {
    // return endMoment;
...
var isNonWorkingTime = (exports.isNonWorkingTime = function isNonWorkingTime(
  schedulerData,
  time
) {
  var localeMoment = schedulerData.localeMoment;
