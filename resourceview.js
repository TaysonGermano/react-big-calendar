    ...
    (function (_Component) {
      ...
      function ResourceView(props) {
        ...
        return _possibleConstructorReturn(
          this,
          (ResourceView.__proto__ || Object.getPrototypeOf(ResourceView)).call(
            this,
            props
          )
        );
      ...
      _createClass(ResourceView, [
        {
          ...
          value: function render() {
            ...
            var resourceList = displayRenderData.map(function (item) {
              ...
              var indent = _react2.default.createElement("span", {
                key: "es" + item.indent,
                className: "expander-space",
              });
              if (item.hasChildren) {
              ...
              if (!!slotItemTemplateResolver) {
                var temp = slotItemTemplateResolver(
                  schedulerData,
                  item,
                  slotClickedFunc,
                  width,
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement("tbody", null, resourceList)
              )
            );
          },
        },
